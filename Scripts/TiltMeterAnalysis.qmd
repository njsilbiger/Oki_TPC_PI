...
p <- ggplot(TiltEllipses, aes( x = x, y = y, color = Site)) +
...
SiteMap <- get_map(Site7, zoom = 11, maptype = "hybrid")
...
ggmap(SiteMap1) +
  geom_point(data = LatLong, 
            aes(x = Long, y = Lat, color = fct_reorder(Site, Long)), 
            size = 5) +
